...
from utils.constants import insert_to_nba_player_table_query
...
for _, row in g_league_players.iterrows():
    cursor.execute(insert_to_nba_player_table_query, (row['PERSON_ID'], row['PLAYER_LAST_NAME'], row['PLAYER_FIRST_NAME'], row['PLAYER_SLUG']))
